...
import com.fugui.train.member.domain.Ticket;
import com.fugui.train.member.domain.TicketExample;
import com.fugui.train.member.mapper.TicketMapper;
...
public class TicketService {
    ...
    public void save(MemberTicketReq req) throws Exception {
        ...
        ticket.setId(SnowUtil.getSnowflaskNextId());
